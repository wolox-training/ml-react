  ...
  render() {
    ...
    if (this.props.notFound) {
      return (
        <div className="body">
          <Link className="back" to="/dashboard">&lt; Volver</Link>
          <span className="not-found">This is not the book you are looking for</span>
        </div>
      );
    }
    return (
          ...
          <div className="book-detail">
            ...
            <div className="book-info">
              ...
              {!this.props.available ?
                <button className="rent-button" disabled={this.props.wish} onClick={this.props.onWish(this.props.book.id)}>Wish</button> :
